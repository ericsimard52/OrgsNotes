...
** Quoting double quote VS single quote
   ...
   In this example, we demonstrate the difference between "" and '' with the ls command.
   ...
   Here we demonstrate the same thing using a variable.
...
* Variable & function
   ...
   Example:
   #+BEGIN_SRC bash :results output :exports code :tangle var.sh :tangle-mode (identity #o0755)
     #!/bin/bash
     ...
     # b is a string, but no error will come of this.
     ((d=$b+3))
     echo $d
   #+END_SRC
...
**** -r readonly
     ...
     #+RESULTS:
     : roVar: 2
     : /tmp/babel-85469c-/sh-script-8546pgo: line 5: roVar: readonly variable
     : roVar: 2
...
**** -i integer
     ...
     myInt=2
     echo $myInt
     myInt="I am a string." # Bash will complain, myInt=0. Same behavior with single quote.
     echo $myInt
...
**** Bash specific operators
     ...
     #+BEGIN_SRC bash :results output :exports code :tangle ifComparison.sh :tangle-mode (identity #o0755)
      #!/bin/bash
      ...
      # This does not throw an error, by will equal false.
    ...
    Works the same.
    :END:
     #+BEGIN_SRC bash :results output :exports code :tangle intComparison.sh :tangle-mode (identity #o0755)
      #!/bin/bash
      ...
      # This does not throw an error and in this case it evals to true.
...
**** More common way to test
    ...
    #+END_SRC
     ...
     #+BEGIN_SRC bash :results output :exports code :tangle intComparisonCont.sh :tangle-mode (identity #o0755)
       #!/bin/bash
...
**** String Comparison
      ...
      #+BEGIN_SRC  bash :results output :exports code :tangle strComparison.sh :tangle-mode (identity #o0755)
        #!/bin/bash
...
** Case statement
   ...
   :README:
    ...
    :END:
   #+BEGIN_SRC bash :results output :export code :tangle simpleCase.sh  :tangle-mode (identity #o0755)
     #!/bin/bash
...
** For loop
   ...
   #+BEGIN_SRC bash :results output :export code :tangle forLoop.sh :tangle-mode (identity #o0755)
     #!/bin/bash
   ...
   #+BEGIN_SRC bash :results output :export code :tangle loopArgs.sh :tangle-mode (identity #o0755) :cmdline arg1 myarg 3
     #!/bin/bash
...
** While loop
   ...
   Example: Loop through an array
   #+BEGIN_SRC bash :results output :export code :tangle whileLoop.sh :tangle-mode (identity #o0755)
     #!/bin/bash
...
** until loop
   ...
   #+BEGIN_SRC bash :results output :export code :tangle untilLoop.sh :tangle-mode (identity #o0755)
     #!/bin/bash
...
*** Break is used to stop a loop before its normal ending.
    #+BEGIN_SRC bash :results output :export code :tangle userBreak.sh  :tangle-mode (identity #o0755)
      #!/bin/bash
...
*** Continue
    ...
    #+BEGIN_SRC bash :results output :export code :tangle contLoop.sh  :tangle-mode (identity #o0755)
      #!/bin/bash
    ...
    #+BEGIN_SRC bash :results output :export code :tangle contInfinit.sh  :tangle-mode (identity #o0755)
      #!/bin/bash
...
* Passing arguments to your scripts
  ...
  #+BEGIN_SRC bash :results output :export code :tangle argsForLoop.sh  :tangle-mode (identity #o0755) :cmdline myArg1 myArg2
    #!/bin/bash
  ...
  #+BEGIN_SRC bash :results output :export code :tangle argsWhileLoop.sh  :tangle-mode (identity #o0755) :cmdline hello how are you
    #!/bin/bash
    x=0
...
*** Space separated
    ...
    #+BEGIN_SRC bash :results output :export code :tangle argsWhileLoop.sh  :tangle-mode (identity #o0755) :cmdline -o rw,ext4,0755 --file /tmp/test
      #!/bin/bash
...
**** Usage
    ...
    #+BEGIN_SRC bash :results output :export code :tangle getoptsSimple.sh  :tangle-mode (identity #o0755) :cmdline -o -g -f
      #!/bin/bash
    ...
    #+BEGIN_SRC bash :results output :export code :tangle getoptsWithArgs.sh  :tangle-mode (identity #o0755) :cmdline -o -g -f /var/log/syslog
      #!/bin/bash
    ...
    #+BEGIN_SRC bash :results output :export code :tangle getoptsOPTIND.sh  :tangle-mode (identity #o0755) :cmdline -o -g -f /var/log/syslog
      #!/bin/bash
      declare fVal oVal=0 gVal=0
...
**** getopts and Errors
     ...
     #+BEGIN_SRC bash :results output :export code :tangle getoptsErr.sh  :tangle-mode (identity #o0755) :cmdline -o -g -f
      #!/bin/bash
      declare fVal oVal=0 gVal=0
    ...
    #+END_SRC
     ...
     #+BEGIN_SRC bash :results output :export code :tangle getoptsErrSilent.sh  :tangle-mode (identity #o0755) :cmdline -o -g -f
      #!/bin/bash
      declare fVal oVal=0 gVal=0
    ...
    #+END_SRC
     ...
     #+BEGIN_SRC bash :results output :export code :tangle getoptsOPTERR.sh  :tangle-mode (identity #o0755) :cmdline -o -g -f
      #!/bin/bash
      declare fVal oVal=0 gVal=0
    ...
    #+END_SRC
     ...
     #+BEGIN_SRC bash :results output :export code :tangle getoptsInvalidOpt.sh  :tangle-mode (identity #o0755) :cmdline -o -g -x
       #!/bin/bash
       declare fVal oVal=0 gVal=0
    ...
    #+END_SRC
     ...
     #+BEGIN_SRC bash :results output :export code :tangle getoptsInvalidOptSilent.sh  :tangle-mode (identity #o0755) :cmdline -o -g -x
       #!/bin/bash
       declare fVal oVal=0 gVal=0
     ...
     #+BEGIN_SRC bash :results output :export code :tangle getoptsInvalidOptNotSilent.sh  :tangle-mode (identity #o0755) :cmdline -o -g -f
       #!/bin/bash
       declare fVal oVal=0 gVal=0
     ...
     #+BEGIN_SRC bash :results output :export code :tangle getoptsInvalidOptSilent.sh  :tangle-mode (identity #o0755) :cmdline -o -g -f
       #!/bin/bash
       declare fVal oVal=0 gVal=0
