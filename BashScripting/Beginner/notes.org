...
** Functions
   ...
   #+BEGIN_SRC bash :results output :exports code :tangle funcReturn.sh :tangle-mode (identity #o0755)
     #!/bin/bash
   ...
   #+BEGIN_SRC bash :results output :exports code :tangle funcRefVar.sh :tangle-mode (identity #o0755)
     #!/bin/bash
   ...
   #+BEGIN_SRC bash :results output :exports code :tangle emptyFunc.sh :tangle-mode (identity #o0755) :cmdline 2>&1
     #!/bin/bash
...
** Case statement
   ...
   :README:
    ...
    :END:
   #+BEGIN_SRC bash :results output :exports code :tangle simpleCase.sh  :tangle-mode (identity #o0755) :cmdline 2>&1
     #!/bin/bash
...
** For loop
   ...
   #+BEGIN_SRC bash :results output :exports code :tangle forLoop.sh :tangle-mode (identity #o0755) :cmdline 2>&1
     #!/bin/bash
   ...
   #+BEGIN_SRC bash :results output :exports code :tangle loopArgs.sh :tangle-mode (identity #o0755) :cmdline arg1 myarg 3 2>&1
     #!/bin/bash
...
** While loop
   ...
   Example: Loop through an array
   #+BEGIN_SRC bash :results output :exports code :tangle whileLoop.sh :tangle-mode (identity #o0755) :cmdline 2>&1
     #!/bin/bash
...
** until loop
   ...
   #+BEGIN_SRC bash :results output :exports code :tangle untilLoop.sh :tangle-mode (identity #o0755) :cmdline 2>&1
     #!/bin/bash
...
*** Input redirection
    ...
    :END:
    #+NAME helpRead
    #+BEGIN_SRC bash :results output :exports none :tangle no :epiloge "read --help"
    #!/bin/bash
    cat - < <(read --help)
    #+END_SRC
    ...
    #+BEGIN_SRC bash :results output :exports code :tangle ioLoop1.sh  :tangle-mode (identity #o0755) :cmdline 2>&1
      #!/bin/bash
...
*** Break is used to stop a loop before its normal ending.
    #+BEGIN_SRC bash :results output :exports code :tangle userBreak.sh  :tangle-mode (identity #o0755) :cmdline 2>&1
      #!/bin/bash
...
*** Continue
    ...
    #+BEGIN_SRC bash :results output :exports code :tangle contLoop.sh  :tangle-mode (identity #o0755) :cmdline 2>&1
      #!/bin/bash
    ...
    #+BEGIN_SRC bash :results output :exports code :tangle contInfinit.sh  :tangle-mode (identity #o0755) :cmdline 2>&1
      #!/bin/bash
...
* Passing arguments to your scripts
  ...
  #+BEGIN_SRC bash :results output :exports code :tangle argsForLoop.sh  :tangle-mode (identity #o0755) :cmdline myArg1 myArg2 2>&1
    #!/bin/bash
  ...
  #+BEGIN_SRC bash :results output :exports code :tangle argsWhileLoop.sh  :tangle-mode (identity #o0755) :cmdline hello how are you 2>&1
    #!/bin/bash
    x=0
...
*** Space separated
    ...
    #+BEGIN_SRC bash :results output :exports code :tangle argsWhileLoop.sh  :tangle-mode (identity #o0755) :cmdline -o rw,ext4,0755 --file /tmp/test 2>&1
      #!/bin/bash
...
**** Usage
    ...
    #+BEGIN_SRC bash :results output :exports code :tangle getoptsSimple.sh  :tangle-mode (identity #o0755) :cmdline -o -g -f 2>&1
      #!/bin/bash
    ...
    #+BEGIN_SRC bash :results output :exports code :tangle getoptsWithArgs.sh  :tangle-mode (identity #o0755) :cmdline -o -g -f /var/log/syslog 2>&1
      #!/bin/bash
    ...
    #+BEGIN_SRC bash :results output :exports code :tangle getoptsOPTIND.sh  :tangle-mode (identity #o0755) :cmdline -o -g -f /var/log/syslog 2>&1
      #!/bin/bash
      declare fVal oVal=0 gVal=0
...
**** getopts and Errors
     ...
     #+BEGIN_SRC bash :results output :exports code :tangle getoptsErr.sh  :tangle-mode (identity #o0755) :cmdline -o -g -f 2>&1
      #!/bin/bash
      declare fVal oVal=0 gVal=0
     ...
     #+BEGIN_SRC bash :results output :exports code :tangle getoptsErrSilent.sh  :tangle-mode (identity #o0755) :cmdline -o -g -f 2>&1
      #!/bin/bash
      declare fVal oVal=0 gVal=0
    ...
    #+END_SRC
     ...
     #+BEGIN_SRC bash :results output :exports code :tangle getoptsOPTERR.sh  :tangle-mode (identity #o0755) :cmdline -o -g -f 2>&1
      #!/bin/bash
      declare fVal oVal=0 gVal=0
    ...
    #+END_SRC
     ...
     #+BEGIN_SRC bash :results output :exports code :tangle getoptsInvalidOpt.sh  :tangle-mode (identity #o0755) :cmdline -o -g -x 2>&1
       #!/bin/bash
       declare fVal oVal=0 gVal=0
    ...
    #+END_SRC
     ...
     #+BEGIN_SRC bash :results output :exports code :tangle getoptsInvalidOptSilent.sh  :tangle-mode (identity #o0755) :cmdline -o -g -x 2>&1
       #!/bin/bash
       declare fVal oVal=0 gVal=0
     ...
     #+BEGIN_SRC bash :results output :exports code :tangle getoptsInvalidOptNotSilent.sh  :tangle-mode (identity #o0755) :cmdline -o -g -f 2>&1
       #!/bin/bash
       declare fVal oVal=0 gVal=0
     ...
     #+BEGIN_SRC bash :results output :exports code :tangle getoptsInvalidOptSilent.sh  :tangle-mode (identity #o0755) :cmdline -o -g -f 2>&1
       #!/bin/bash
       declare fVal oVal=0 gVal=0
...
* Making menus with the select built-in
  ...
  #+BEGIN_SRC bash :results output :exports code :tangle simpleSelect.sh :tangle-mode (identity #o0755) :cmdline 2>&1
    #!/bin/bash
...
** Submenus
   ...
   Due to the interactive nature of this code, it must be exported C-u C-c C-v t
  #+BEGIN_SRC bash :results output :exports code :tangle selectSubMenu.sh :tangle-mode (identity #o0755) :cmdline 2>&1
    #!/bin/bash
...
#+NAME: Main
#+BEGIN_SRC bash :eval no :tangle no :tangle-mode (identity #o0755) :noweb strip-export :exports no
  ###
...
#+NAME: scriptHeader
#+BEGIN_SRC bash :eval no :tangle no :tangle-mode (identity #o0755) :exports no
...
#+NAME:enableSub
#+BEGIN_SRC bash :eval no :tangle no :exports no
  function enableSub {
        declare psBAK=$PS3
        declare -a subMenus
        export PS3=$'>>> '
